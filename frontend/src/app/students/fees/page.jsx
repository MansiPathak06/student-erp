...
//   const [step, setStep]         = useState("amount");   // amount | uploading | done
...
//   const [paidMeta, setPaidMeta] = useState(null); // {order_id, payment_id, amount}
...
//     if (Number(amount) > remaining) return setError(`Max payable: ₹${remaining}`);
...
//           try {
//             const verified = await apiFetch("/fees/payment/verify", {
//               method: "POST",
//               body: JSON.stringify({
...
//             <h2 className="text-white font-bold text-base">Pay Fees</h2>
//           </div>
...
//                     className="w-full pl-8 pr-3 py-3 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-violet-300"
//                   />
//                 </div>
//                 <button
...
//               <div className="flex items-center gap-2 text-xs text-gray-400 bg-blue-50 border border-blue-100 rounded-xl px-3 py-2.5">
...
//                 className="w-full bg-violet-600 hover:bg-violet-700 disabled:opacity-60 text-white font-bold py-3 rounded-xl flex items-center justify-center gap-2 transition-all"
//               >
...
//                 Upload your Razorpay payment receipt or screenshot for admin verification.
//               </p>

//               {/* File drop zone */}
//               <label className="block cursor-pointer">
//                 <div className={`border-2 border-dashed rounded-xl p-6 text-center transition-all ${receipt ? "border-violet-300 bg-violet-50" : "border-gray-200 hover:border-violet-200"}`}>
//                   {preview ? (
//                     <img src={preview} alt="Receipt preview" className="mx-auto max-h-40 rounded-lg object-contain" />
//                   ) : receipt ? (
...
//               </div>
//               <div>
//                 <p className="font-bold text-gray-900 text-lg">Receipt Submitted!</p>
//                 <p className="text-sm text-gray-500 mt-1">Admin will verify and approve your payment. Your fee status will update automatically.</p>
//               </div>
//               <button
//                 onClick={onClose}
...
//                     className="flex items-center gap-2 px-4 py-2 rounded-xl bg-violet-600 hover:bg-violet-700 text-white text-sm font-bold transition-all shadow-sm"
//                   >
//                     <CreditCard size={14} />
//                     Pay Now
//                   </button>
...
//                 {/* Pay Now CTA — only if pending balance */}
//                 {canPay && (
//                   <button
//                     onClick={() => setShowPayment(true)}
//                     className="w-full bg-violet-600 hover:bg-violet-700 text-white font-bold py-3.5 rounded-2xl flex items-center justify-center gap-2 transition-all shadow-sm"
//                   >
//                     <CreditCard size={18} />
...
//                               >
//                                 <div className="w-12 h-12 rounded-lg border border-gray-200 overflow-hidden bg-gray-50 flex items-center justify-center hover:opacity-80 transition-opacity">
